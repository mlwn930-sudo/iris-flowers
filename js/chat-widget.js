...
function agamNextQuestion(slots) {
  ...
  if (!slots.occasion) return "לאיזו הזדמנות זה? עם זה אני כבר קולעת.";
  ...
  if (!slots.budget) return "יש סכום שנוח לך? אני אתאים אליו בלי להעליב אף אחד.";
...
function agamReply(message) {
  ...
  // 6. באמת לא הבנו — מנחשים בגלוי, אף פעם לא משאירים ריק
  a.lastIntent = null;
...
const MICHAEL_INTENTS = [
  ...
  },
  {
    ...
    reply: () =>
      "לפי הסדר:\n1. רענון מלא — Ctrl+F5 במחשב, משיכה למטה בנייד. מנקה גרסה ישנה שנתקעה. פותר את רוב המקרים.\n2. חוזר? לשונית פרטית. עבד שם — אשם תוסף בדפדפן, בדרך כלל חוסם פרסומות.\n3. עדיין תקוע — מכשיר, דפדפן, ומה היה על המסך. מעביר הלאה עם הפרטים.",
  },
  {
    name: "tech_cart",
    ...
    kw: ["עגלה", "סל", "נשמר"],
    reply: () =>
      "העגלה יושבת בדפדפן שלך, לא בשרת. מכוון — אנחנו לא שומרים עליך מידע שלא צריך.\nהיא מתאפסת ב: גלישה פרטית, ניקוי היסטוריה, מעבר למכשיר אחר.\nבאותו דפדפן היא שורדת סגירת כרטיסייה. לא שרדה — תגיד לי דפדפן וגרסה.",
  },
  {
    name: "tech_images",
...
function michaelPick(kind) {
  ...
  if (kind === "track") {
    ...
    agentSay("michael", "שלושה פרטים ואוכל לאבחן: מה ניסית לעשות, מה קרה בפועל, באיזה מכשיר.\nאם אין כוח לפרט — תכתוב מה לא עבד ואתחיל משם.");
  }
